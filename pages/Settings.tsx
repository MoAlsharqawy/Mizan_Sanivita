...
export default function Settings() {
  ...
  const [activeTab, setActiveTab] = useState<'general' | 'invoice' | 'users' | 'printer' | 'backup'>('general');
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="space-y-6 animate-in fade-in">
                <div className="border-b pb-4">
                    <h3 className="font-bold text-gray-800 flex items-center gap-2 mb-2">
                        <Database className="w-5 h-5 text-blue-600" /> Database Management
                    </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col items-center text-center">
                        ...
                        <h4 className="font-bold text-gray-800 mb-2">Export Data (Backup)</h4>
                        <p className="text-xs text-gray-500 mb-6">Download a complete JSON file of all your invoices, customers, and inventory.</p>
                        <button 
                    ...
                    <div className="bg-amber-50 p-6 rounded-xl border border-amber-100 flex flex-col items-center text-center">
                        ...
                        <h4 className="font-bold text-gray-800 mb-2">Import Data (Restore)</h4>
                        <p className="text-xs text-gray-500 mb-6">Restore data from a backup file. <span className="text-red-500 font-bold">Warning: This overwrites current data.</span></p>
      ...
      <div className="bg-red-50 p-6 rounded-xl border border-red-100 flex justify-between items-center mt-8">
        <span className="text-red-800 font-medium">{t('set.reset')}</span>
        <button onClick={() => { if(confirm('Sure? This will delete ALL data permanently!')) db.resetDatabase(); }} className="bg-red-600 text-white px-4 py-2 rounded-lg flex items-center gap-2">
