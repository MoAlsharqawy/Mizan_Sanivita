...
import { Supplier, PurchaseInvoice, CashTransaction } from '../types';
...
function Suppliers() {
  ...
  const statementData = useMemo(() => {
    ...
    const supplierPurchases = purchases.filter((p) => p.supplier_id === statementSupplier.id);
    ...
    const supplierPayments = payments.filter(tx => 
